...
- Replaced the Day 2 USJ Express Pass 7 plan with USJ VIP 8h.
- Added the user-provided USJ VIP 8h reference amount of TWD 87,000 to the active budget model.
- Treated USJ VIP 8h as including lunch, dinner, and in-park dining, so USJ park dining is no longer listed as a separate budget line.
...
- Updated the active recommended budget to NT$272,454 for two travelers, controlled scenario to NT$267,756, safety version to NT$280,000, and hard ceiling to NT$280,000.
- Added version note `docs/13_版本與更新/V5.53.0_USJ_VIP_8h_Budget_Update.md`.

### Reason

The user changed the USJ strategy from Express Pass 7 to USJ VIP 8h and clarified that VIP 8h includes lunch, dinner, and in-park dining. Therefore, USJ park dining and shopping should not remain as a separate budget line, and USJ shopping should be merged into the ordinary shopping category.

### Impact

- Day 2 USJ now uses USJ VIP 8h as the active planning strategy.
- The active recommended TWD budget is now NT$272,454 for two travelers.
- The safety version and hard ceiling are both NT$280,000.
- The remaining buffer between the recommended budget and hard ceiling is about NT$7,546.
- Studio Pass still requires reconfirmation because the project must verify whether USJ VIP 8h includes admission.
