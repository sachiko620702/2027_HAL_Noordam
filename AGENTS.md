...
- Day 4 sushi note: V5.22.0 sushi preference is superseded by the NOKA plan; Day 4 sushi remains fallback-only.
...
- USJ transfer: KKday #536220 for both hotel to USJ and USJ to hotel. V5.24.0 reference price is TWD 1,732 each way, TWD 3,464 round trip. Purchase date not yet assigned in V5.26.2 timeline.
- Active budget model: recommended total TWD 237,896 for two travelers; safety ceiling TWD 380,000; Ambassador renewal USD 250, luxury handbags, jewelry, and watches are separate. Lodging should be estimated net of the lower-price complimentary night, not using the temporary checkout charge peak.
