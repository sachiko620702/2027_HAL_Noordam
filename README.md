...
- 固定重點：USJ 一天、USJ VIP 5 小時、好吃優先餐飲、精品購物、寶可夢／動漫、日本橋模型周邊、候補景點與候補美食資料庫

## 目前主控版本

- Version：V5.54.0 USJ VIP 5h Budget Update
- 主控資料源：GitHub main branch
- 更新目的：依使用者指示將 USJ Express Pass 7 改為 USJ VIP 5 小時，並重算 USJ、購物與主預算。
- 最新主預算：建議版 NT$245,454／兩人，節制版 NT$240,756／兩人，安全版 NT$280,000／兩人，硬上限 NT$280,000／兩人。
...
- USJ 園區餐飲與購物：不再單獨列出；VIP 5 小時視為包含午餐、晚餐與園內餐飲；USJ 周邊購物與普通購物合併為 NT$14,000。
...
- 2027/09/17：購買／預約 USJ VIP 5 小時，暫以 TWD 60,000 納入主預算；官方條件仍需再次確認。
- 2027/09/17：NOKA Roast & Grill 訂位，需確認套餐、主菜、90 分鐘暢飲、紀念日備註與特價菜單日不適用條件。
- 2027/10/10：買 KKday #129909 機場接送、KKday #536220 飯店 ↔ USJ 接送，以及 USJ Studio Pass；USJ Studio Pass 最終票價與是否已含於 VIP 5 小時仍需再次確認。
...
- Day 2 正式確認：USJ 一日遊，Express Pass 7 改為 USJ VIP 5 小時；VIP 方案視為包含午餐、晚餐與園內餐飲。
...
- 公開網站：`web/` 已於 V5.54.0 同步 USJ VIP 5 小時與預算更新；網站視覺沿用 V5.52.0 旅行社宣傳頁風格。
...
- [預約與購買時間軸 V5.54.0](docs/03_預約購買/2027大阪自由行_預約購買時間軸_V5.26.0.md)
...
- [V5.54.0 USJ VIP 5 小時預算更新紀錄](docs/13_版本與更新/V5.54.0_USJ_VIP_5h_Budget_Update.md)
