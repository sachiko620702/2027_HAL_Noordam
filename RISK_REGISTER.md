...
## R001 USJ 2027 ticket delay

Risk: 2027 tickets and Express Pass details are not published yet.
Impact: USJ strategy may change.
Mitigation: mark prices and rules as pending until official release.
...
Risk: lounge, breakfast, early check-in, or upgrade rules may change.
Impact: hotel experience assumptions may change.
Mitigation: verify with hotel official source before departure.

## R005 Weather and event conflict

Risk: November weather or events may affect daily plan.
Impact: outdoor attractions may need backup.
Mitigation: keep rainy-day and slow-travel alternatives.

## R006 Duplicate data

Risk: AI tools may create duplicate restaurant or attraction entries.
Impact: database quality decreases.
Mitigation: search database and docs before each update.
