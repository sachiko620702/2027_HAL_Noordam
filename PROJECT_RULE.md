...
- Flight budget reference: TWD 36,000 for two travelers round trip, user-provided in V5.26.0; planned purchase time is 2026/11; final ticket price still needs confirmation.
...
- Budget model: use V5.26.0 recommended total TWD 325,664 for two travelers and safety ceiling TWD 380,000. Luxury handbags, jewelry, watches, and Ambassador renewal USD 250 are separate.
